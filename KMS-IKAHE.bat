...
echo 有问题请留言http://192.168.150.82
...
:start2
set KMS_Sev=192.168.150.82
cls
echo 正在检查本机网络情况耐心等待
echo.
ping 192.168.150.82 | find "超时"  > NUL &&  goto fail
ping 192.168.150.82 | find "目标主机"  > NUL &&  goto fail
echo 本机网络良好……
goto office
...
if DEFINED _Office%1Path (
    ...
    cscript //nologo ospp.vbs /sethst:192.168.150.82 >nul
...
if defined %EditionID% (
	...
	cscript //Nologo %windir%\system32\slmgr.vbs /skms 192.168.150.82
